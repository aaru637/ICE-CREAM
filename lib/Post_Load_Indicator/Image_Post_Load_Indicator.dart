...
class Image_Post_Load_Indicator extends StatefulWidget {
  final Uint8List image;
  const Image_Post_Load_Indicator({Key? key, required this.image})
      : super(key: key);

  @override
  State<Image_Post_Load_Indicator> createState() =>
      _Image_Post_Load_IndicatorState();
}

class _Image_Post_Load_IndicatorState extends State<Image_Post_Load_Indicator> {
  ...
  void initState() {
    ...
    super.initState();
    Post_Auth.uploadImagePost(widget.image, "images", context);
  }
